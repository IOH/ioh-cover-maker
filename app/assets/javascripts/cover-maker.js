...
$(function(){
   ...
   */
  function postToPoster()
  {

  	var use_avatar     = $('#selfie-toggle').prop('checked'),
  			name           = $('#name-textarea').val(),
  			description    = $('#poster-content-textarea').val(),
  			info_one       = $('#experience-1').val(),
  			info_one_red   = $('#experience-toggle-1').prop('checked'),
  			info_two       = $('#experience-2').val(),
  			info_two_red   = $('#experience-toggle-2').prop('checked'),
  			info_three     = $('#experience-3').val(),
  			info_three_red = $('#experience-toggle-3').prop('checked');
